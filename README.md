...
*The ELI5 Version:*  
The project studies years of a stock's price history and looks for patterns, the same way you might notice that it always rains after certain clouds appear. Once it has learned those patterns it looks at what is happening today and makes a simple prediction: up or down tomorrow. It then grades its own homework by checking those predictions against what actually happened.
